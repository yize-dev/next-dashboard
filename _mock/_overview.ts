...
export const _appRecentFestivals = [
  {name: "Labor Day", days: 24},  {name: "Black Friday", days: 105},  {name: "Cyber Monday", days: 108}, 
  {name: "Christmas", days: 136},  {name: "Spring Festiva", days: 183}, 
];

export const _ecommerceLatestProducts = [...Array(8)].map((_, index) => {
