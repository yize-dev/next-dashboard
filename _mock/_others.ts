...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  type: ['order', 'order', 'order', 'order', 'order', 'order', 'chat', 'mail', 'delivery'][
    index
  ],
  category: [
    'Communication',
  ...
  title: `<p>You have new message 5 unread messages</p>`
    ...
    // (index === 1 && `<p>You have new message</p>`) ||
    // (index === 2 && `<p>You have new message</p>`) ||
    // (index === 3 && `<p>You have new message</p>`) ||
    // (index === 4 && `<p>You have new message</p>`) ||
    ...
    // (index === 9 && `<p>You have new message 5 unread messages</p>`)
}));
