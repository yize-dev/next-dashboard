...
const ICONS = {
  ...
  inspection: icon('ic_check'),
  inquiry: icon('ic_letter_opened'),
};
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          // ORDER
          {
            ...
            icon: ICONS.order,
            child: [
              { title: t('pending'), path: paths.dashboard.order.root },
              { title: t('fulfilled'), path: paths.dashboard.order.demo.details },
              { title: t('reship'), path: paths.dashboard.order.demo.details },
            ],
          },
          // PRODUCT
          {
          ...
          {
            title: t('inspection'),
            path: paths.dashboard.inspection,
